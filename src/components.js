...
const h1 = props => <Heading {...props} fontSize={[3, 4, 5]} />

const h2 = props => <H2 {...props} fontSize={[2, 3, 4]} />

const h3 = props => <H3 {...props} fontSize={[2, 3]} />

const h4 = props => <H4 {...props} fontSize={[2, 3]} />

const h5 = props => <H5 {...props} fontSize={[2, 3]} />
